...
class PlayerTest {
    ...
    public void testConstructor() {
        Player player1 = new Player(10, 10, new TimeInterval(100), new Printer(new DefaultMapStyler()));
        ...
        Player player2 = new Player(5, 10, new TimeInterval(100), new Printer(new DefaultMapStyler()));
